import { View, Text,Image,TouchableOpacity,StyleSheet ,Dimensions,StatusBar, TextInput,Linking, ActivityIndicator} from 'react-native'
    ...
    <View style={styles.container}>
        ...
        <View  style={styles.imageContainer}>
            <Animatable.Image 
                ...
                duraton="1500" 
                delay={700}
                source={require('../assets/images/Saly-25.png')} style={styles.image} resizeMode='contain'
        ...
        <Animatable.View animation={'fadeInUpBig'} style={styles.containersec}>
            ...
            <Feather style={{color:'green',alignSelf:'center'}} name="check-circle" size={18}      color="black" /> 
            :null}
            </View>
            <View style={styles.tc}>
                ...
                <View style={styles.tc}>
                <MaterialCommunityIcons style={styles.icon} name="account-check-outline" size={18} color="black" />
                  <Text style={styles.tandc}>Create an account? </Text>
                     ...
                     <Text style={{  
                        ...
                        onPress={() =>navb.navigate('CreateAccount')}>Sign Up</Text>
